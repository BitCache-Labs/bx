...
struct ConnectPipeline : public LazyInit<ConnectPipeline, ComputePipelineHandle>
{
    ConnectPipeline()
    {
        ...
        shaderCreateInfo.name = "Nert Connect Shader";
        ...
        pipelineCreateInfo.name = "Nert Connect Pipeline";
...
struct ExtendPipeline : public LazyInit<ExtendPipeline, ComputePipelineHandle>
{
    ...
    {
        ShaderCreateInfo shaderCreateInfo{};
        shaderCreateInfo.name = "Nert Extend Shader";
        shaderCreateInfo.shaderType = ShaderType::COMPUTE;
        ...
        ComputePipelineCreateInfo pipelineCreateInfo{};
        pipelineCreateInfo.name = "Nert Extend Pipeline";
        pipelineCreateInfo.layout = pipelineLayoutDescriptor;
        pipelineCreateInfo.shader = shader;
        data = Graphics::CreateComputePipeline(pipelineCreateInfo);
    ...
    : createInfo(createInfo)
{
    ...
    for (u32 i = 0; i < 2; i++)
    {
        ...
        raysCreateInfo.name = Log::Format("Nert Rays {} Buffer", i);
        ...
        rayCountCreateInfo.name = Log::Format("Nert Ray Count {} Buffer", i);
        ...
        pixelMappingCreateInfo.name = Log::Format("Nert Pixel Mapping {} Buffer", i);
    ...
    shadowRayOriginsCreateInfo.name = "Nert Shadow Ray Origins Buffer";
    ...
    shadowRayCountCreateInfo.name = "Nert Shadow Ray Count Buffer";
    ...
    shadowRayPixelMappingCreateInfo.name = "Nert Shadow Ray Pixel Mapping Buffer";
    ...
    payloadsCreateInfo.name = "Nert Payloads Buffer";
    ...
    connectBindGroupCreateInfo.name = "Nert Connect Bind Group";
    ...
    raygenBindGroupCreateInfo.name = "Nert Raygen Bind Group";
    ...
    resolveBindGroupCreateInfo.name = "Nert Resolve Bind Group";
...
void NertPass::Dispatch(const Camera& camera, const BlasDataPool& blasDataPool, const MaterialPool& materialPool, const Sky& sky)
{
    ...
    for (u32 bounce = 0; bounce < 1/*maxBounces*/; bounce++)
    {
        ...
        shadeConstantsCreateInfo.name = "Nert Shade Constants Buffer";
        ...
        extendBindGroupCreateInfo.name = "Nert Extend Bind Group";
        ...
        shadeBindGroupCreateInfo.name = "Nert Shade Bind Group";
        ...
        if (bounce > 0 || !hybrid)
        {
            computePassDescriptor.name = "Nert Extend";
        ...
        computePassDescriptor.name = "Nert Connect";
        computePass = Graphics::BeginComputePass(computePassDescriptor);
        {
