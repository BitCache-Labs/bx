...
static const StringView g_graphicsSrc = R"(
...
//BX_SCRIPT_API_REGISTRATION(Graphics)
//{
//	Script::Get().BeginModule("graphics");
//	{
//		Script::Get().BeginClass("Graphics");
//		{
...
//	src.moduleName = "graphics";
//	src.moduleSource = g_graphicsSrc;
//	return src;
//}